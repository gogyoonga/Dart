...
class EtcDrugScreen extends StatefulWidget {
  final String symptom;
  const EtcDrugScreen({Key? key, required this.symptom}) : super(key: key);

  @override
  _EtcDrugScreenState createState() => _EtcDrugScreenState();

}
class _EtcDrugScreenState extends State<EtcDrugScreen> {
  @override
